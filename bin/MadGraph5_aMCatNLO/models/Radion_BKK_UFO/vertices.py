...
V_12 = Vertex(name = 'V_12',
              particles = [ P.a, P.a, P.R ],
              color = [ '1' ],
              lorentz = [ L.VVS2 ],
              couplings = {(0,0):C.GC_19})

V_13 = Vertex(name = 'V_13',
              particles = [ P.a, P.BKK, P.R ],
              color = [ '1' ],
              lorentz = [ L.VVS2 ],
              couplings = {(0,0):C.GC_15})

V_14 = Vertex(name = 'V_14',
              particles = [ P.BKK, P.Z, P.R ],
              color = [ '1' ],
              lorentz = [ L.VVS1, L.VVS3 ],
              couplings = {(0,1):C.GC_47,(0,0):C.GC_49})

V_15 = Vertex(name = 'V_15',
              particles = [ P.a, P.Z, P.R ],
              color = [ '1' ],
              lorentz = [ L.VVS2 ],
              couplings = {(0,0):C.GC_48})

V_16 = Vertex(name = 'V_16',
              particles = [ P.Z, P.Z, P.R ],
              color = [ '1' ],
              lorentz = [ L.VVS2 ],
...
V_46 = Vertex(name = 'V_46',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_127,(0,1):C.GC_126})
...
V_49 = Vertex(name = 'V_49',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_130,(0,1):C.GC_129})
...
V_74 = Vertex(name = 'V_74',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_81,(0,1):C.GC_87})
...
V_88 = Vertex(name = 'V_88',
              particles = [ P.BKK, P.W__minus__, P.W__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVV1 ],
...
V_120 = Vertex(name = 'V_120',
               particles = [ P.b__tilde__, P.b, P.BKK ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV3 ],
               couplings = {(0,0):C.GC_13})

V_121 = Vertex(name = 'V_121',
               particles = [ P.d__tilde__, P.d, P.BKK ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV3 ],
               couplings = {(0,0):C.GC_13})

V_122 = Vertex(name = 'V_122',
               particles = [ P.s__tilde__, P.s, P.BKK ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV3 ],
               couplings = {(0,0):C.GC_13})

V_123 = Vertex(name = 'V_123',
               particles = [ P.e__plus__, P.e__minus__, P.BKK ],
               color = [ '1' ],
               lorentz = [ L.FFV4 ],
               couplings = {(0,0):C.GC_14})

V_124 = Vertex(name = 'V_124',
               particles = [ P.mu__plus__, P.mu__minus__, P.BKK ],
               color = [ '1' ],
               lorentz = [ L.FFV4 ],
               couplings = {(0,0):C.GC_14})

V_125 = Vertex(name = 'V_125',
               particles = [ P.ta__plus__, P.ta__minus__, P.BKK ],
               color = [ '1' ],
               lorentz = [ L.FFV4 ],
               couplings = {(0,0):C.GC_14})

V_126 = Vertex(name = 'V_126',
               particles = [ P.c__tilde__, P.c, P.BKK ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV5 ],
               couplings = {(0,0):C.GC_13})

V_127 = Vertex(name = 'V_127',
               particles = [ P.t__tilde__, P.t, P.BKK ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV5 ],
               couplings = {(0,0):C.GC_13})

V_128 = Vertex(name = 'V_128',
               particles = [ P.u__tilde__, P.u, P.BKK ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV5 ],
               couplings = {(0,0):C.GC_13})

V_129 = Vertex(name = 'V_129',
               particles = [ P.ve__tilde__, P.ve, P.BKK ],
               color = [ '1' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_14})

V_130 = Vertex(name = 'V_130',
               particles = [ P.vm__tilde__, P.vm, P.BKK ],
               color = [ '1' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_14})

V_131 = Vertex(name = 'V_131',
               particles = [ P.vt__tilde__, P.vt, P.BKK ],
               color = [ '1' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_14})
...
V_162 = Vertex(name = 'V_162',
               ...
               couplings = {(0,0):C.GC_38,(0,1):C.GC_45})
