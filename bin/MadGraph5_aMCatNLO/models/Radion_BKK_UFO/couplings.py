...
GC_13 = Coupling(name = 'GC_13',
                 value = '(ee**2*complex(0,1))/(6.*cw**2*gBKK)',
                 order = {'QED':1})

GC_14 = Coupling(name = 'GC_14',
                 value = '-(ee**2*complex(0,1))/(2.*cw**2*gBKK)',
                 order = {'QED':1})

GC_15 = Coupling(name = 'GC_15',
                 value = '2*cw*complex(0,1)*gRFKK',
                 order = {'QED':1})
...
GC_19 = Coupling(name = 'GC_19',
                 value = '-((ee**2*complex(0,1)*ggrav)/(gBKK**2*MKK))',
                 order = {'QED':1})

GC_20 = Coupling(name = 'GC_20',
                 value = '-((ee*complex(0,1)*sC)/cw)',
                 order = {'QED':1})
...
GC_47 = Coupling(name = 'GC_47',
                 value = '2*complex(0,1)*gRFKK*sw',
                 order = {'QED':1})

GC_48 = Coupling(name = 'GC_48',
                 value = '(ee**2*complex(0,1)*ggrav*sw)/(cw*gBKK**2*MKK)',
                 order = {'QED':1})

GC_49 = Coupling(name = 'GC_49',
                 value = '2*complex(0,1)*gRFKK*MZ**2*sw',
                 order = {'QED':1})

GC_50 = Coupling(name = 'GC_50',
                 value = '-((ee**2*complex(0,1)*ggrav*sw**2)/(cw**2*gBKK**2*MKK))',
                 order = {'QED':1})
...
GC_67 = Coupling(name = 'GC_67',
                 value = '(ee**3*complex(0,1)*vev)/(2.*cw**3*gBKK*sw)',
                 order = {'QED':1})
